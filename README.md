...
| elasticsearch.region          |                            | Elasticsearch region. Specify it if you're connecting to a remote Elasticsearch intance.                                                                                                                       |
| elasticsearch.accessKeyId     |                            | AWS Access Key ID to access Elasticsearch                                                                                                                                                                               |
| elasticsearch.secretAccessKey |                            | AWS Secret Key to access Elasticsearch                                                                                                                                                                               |
